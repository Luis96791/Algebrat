...
import img_sumafuncionseno from '../assets/img_sumafuncionseno.png';

require('../styles/w3.css');
require('../styles/SumaFuncionSenoCalculator.css');

function CalculateSumaFuncionSeno(_angulo1, _angulo2) {
...
function SolutionSumaFuncionSeno(_angulo1, _angulo2) {
    const angulo1 = parseFloat(_angulo1);
    const angulo2 = parseFloat(_angulo2);
    ...
    var result = 'sin(a+b) = sin(a) * cos(b) + sin(b) * cos(a)\n'+
        ...
        'sin(a+b) = '+ CalculateSumaFuncionSeno(angulo1, angulo2);


    return result;
}

class SumaFuncionSenoCalculator extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        const solution = SolutionSumaFuncionSeno(angulo1, angulo2);
        const result = CalculateSumaFuncionSeno(angulo1, angulo2);
        ...
        return (
            <form className="w3-container w3-card-4 w3-light-grey w3-text-teal w3-margin w3-margin-top w3-margin-left w3-margin-right w3-margin-button" >
                <div className="w3-container w3-teal">
                    <h1 className="w3-center">Suma De Ángulos Para La Función Seno</h1>
                </div>
                <p>
                ...
                <p>
                    <img src={img_sumafuncionseno} alt="formula suma funcion seno" /> 
                    <br />
                    <label>Fórmula</label>
                </p>
                <p>
...
export default SumaFuncionSenoCalculator;