...
import img_diferenciafunciontangente from '../assets/img_diferenciafunciontangente.png';

require('../styles/w3.css');
require('../styles/DiferenciaFuncionTangenteCalculator.css');

function CalculateDiferenciaFuncionTangente(_angulo1, _angulo2) {
...
function SolutionDiferenciaFuncionTangente(_angulo1, _angulo2) {
    const angulo1 = parseFloat(_angulo1);
    const angulo2 = parseFloat(_angulo2);
    ...
    var result = 'tan(a-b) = tan(a) - tan(b) / 1 + tan(a) * tan(b)\n'+
        ...
        'tan(a-b) = '+ CalculateDiferenciaFuncionTangente(angulo1, angulo2);


    return result;
}

class DiferenciaFuncionTangenteCalculator extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        const solution = SolutionDiferenciaFuncionTangente(angulo1, angulo2);
        const result = CalculateDiferenciaFuncionTangente(angulo1, angulo2);
        ...
        return (
            <form className="w3-container w3-card-4 w3-light-grey w3-text-indigo w3-margin w3-margin-top w3-margin-left w3-margin-right w3-margin-button" >
                <div className="w3-container w3-indigo">
                    <h1 className="w3-center">Resta De Ángulos Para La Función Tangente</h1>
                </div>
                <p>
                ...
                <p>
                    <img src={img_diferenciafunciontangente} alt="formula diferencia funcion tangente" /> 
                    <br />
                    <label>Fórmula</label>
                </p>
                <p>
...
export default DiferenciaFuncionTangenteCalculator;